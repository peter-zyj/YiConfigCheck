...
Senario
========
Before the Cluster Upgrade/Update ,or,  Customer Running well without big issue
Fetch the Configuration of the Cluster(like the baseline)::
 
time python3 ConfigCheck_v7.py -s 10.94.153.42 -cn standard -sn Before_RUS       //10.94.153.42 is just one member of the cluster
...
DevOps yijunzhu$ cd Before_RUS/
Before_RUS yijunzhu$ tree
.
...
After the Upgrade/Update ,or, Customer report the issues;   Before continue the deep debug/trouble-shooting  
...
Compare the configuration and service status::
